(function() {"use strict";
  ...
  function HomeController($scope, $interval, $timeout)
  {
  	...
  	var social_picks = {
  		...
  		max_radius: 300,
  		picks: [
	  		new Pick(1, simpleicons.twitter.name, "http://twitter.com", simpleicons.twitter.icon, simpleicons.twitter.color, "twitter", false, true),
	  		new Pick(2, simpleicons.deviantart.name, "http://twitter.com", simpleicons.deviantart.icon, simpleicons.deviantart.color, "deviantart", true, true),
	  		new Pick(3, simpleicons.facebook.name, "http://twitter.com", simpleicons.facebook.icon, simpleicons.facebook.color, "facebook", true,  true),
	  		...
	  		new Pick(6, simpleicons.lastfm.name, "http://twitter.com", simpleicons.lastfm.icon, simpleicons.lastfm.color, "lastfm", false, true)
  		]
  	}
  	...
  	var pro_picks = {
  		...
  		max_radius: 300,
  		picks: [
	  		new Pick(1, simpleicons.github.name, "http://twitter.com", simpleicons.github.icon, simpleicons.github.color, "github", false, true),
  	...
  	var contact_picks = {
  		...
  		picks: [
	  		...
	  		new Pick(6, simpleicons.steam.name, "http://twitter.com", simpleicons.steam.icon, simpleicons.steam.color, "steam", false, true)
	  	]
	  }
